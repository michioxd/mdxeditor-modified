...
const CreateLink = () => {
  ...
  return /* @__PURE__ */ React__default.createElement(ButtonWithTooltip, { title: "Tạo liên kết", onClick: (_) => openLinkDialog(true) }, /* @__PURE__ */ React__default.createElement(LinkIcon, null));
};
export {
  CreateLink
};
